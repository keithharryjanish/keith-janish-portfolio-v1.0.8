...
try {
  ...
  assert(detail.includes(mediaUrl(operation.image)), 'Copied banner keeps original artwork');
...
console.log('PASS: copied project builds its route and artwork, gallery, poster, path normalization, missing-image errors and replacement cache versions.');
